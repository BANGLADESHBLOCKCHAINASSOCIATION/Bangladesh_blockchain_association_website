...
export default function Home() {
	return (
		<main className="px-28">
			<Banner />
			<GoalsSection />
			<div className="gradiantBg my-10 flex flex-col justify-center py-20 -mx-28">
				<p className="text-center italic font-serif text-xl max-w-[40%] mx-auto">
			...
			<div className="my-16">
				...
				<div className="flex flex-col gap-8">
					...
					<div className="flex gap-6">
						<TextField className="w-1/2" id="outlined-basic" placeholder="John Doe.com" label="Name" variant="outlined" />
						<TextField className="w-1/2" id="outlined-basic" placeholder="Contribute in an event" label="Subject" variant="outlined" />
					</div>
