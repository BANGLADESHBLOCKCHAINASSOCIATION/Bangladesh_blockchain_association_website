...
export default function Banner() {
	return (
		<div className="flex flex-col justify-center gap-5 -mx-10 lg:-mx-28 lg:px-28 px-10 py min-h-[600px] max-h-[75vh] relative bg-black text-white">
			...
			<p className="whitespace-pre-line text-xl tlg:ext-3xl font-bold lg:leading-10 z-10">{'Empowering The Bangladeshi \nBlockchain Ecosystem'}</p>
			<p className="lg:max-w-[65%] text-sm lg:text-base z-10">
